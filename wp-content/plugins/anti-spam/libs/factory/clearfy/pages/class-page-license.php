                ...
                <div class="license-details">
                    ...
                    <div class="license-details-block <?= $this->get_license_type() ?>-details-block">
                        ...
                        <div class="license-key-description">
							<?php if ( ! $this->is_premium ): ?>
                                <p><?php _e( 'Public License is a GPLv3 compatible license allowing you to change and use this version of the plugin for free. Please keep in mind this license covers only free edition of the plugin. Premium versions are distributed with other type of a license.', 'wbcr_factory_clearfy_216' ) ?></p>
							<?php else: ?>
                                <p><?php _e( 'Сommercial license, only to the premium add-on to this free plugin. You cannot distribute or modify the premium add-on. But free plugin is a GPLv3 compatible license allowing you to change and use this version of the plugin for free.', 'wbcr_factory_clearfy_216' ) ?></p>
							<?php endif; ?>
							<?php if ( $this->is_premium && $this->premium_has_subscription ): ?>
