...
<head>
	...
	<link rel="shortcut icon" href="http://drumcreative.com/wp-content/themes/drumcreative/favicon.png">
	...
	html{
		height:100%;
		background: #ffffff url(https://drumcreative.com/maintenance.jpg); no-repeat center bottom fixed;
...
<body>
	<div id="cspio-page">
		<div id="cspio-content">
			...
			<img id="cspio-logo" src="https://drumcreative.com/maint-logo.png">
			...
			<div id="cspio-socialprofiles">
				<a href="https://www.facebook.com/drumcreative/" target="_blank"><i class="fa fa-facebook-official fa-2x"></i></a>			
				<a href="https://twitter.com/drumcreative" target="_blank"><i class="fa fa-twitter fa-2x"></i></a>			
				<a href="mailto:webmaster@drumcreative.com" target="_blank"><i class="fa fa-envelope fa-2x"></i></a>			
			</div>
