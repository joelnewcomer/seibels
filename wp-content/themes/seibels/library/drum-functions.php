...
function add_featured_image_instruction( $content ) {
	...
	if ($post_id == get_option('page_on_front')) {
		return $content .= '<p>Featured Image must be sized to at least ' . $GLOBALS['home_featured_image_size'] . ' pixels.</p>';
	} else {
		return $content .= '<p>Featured Image must be sized to at least ' . $GLOBALS['featured_image_size'] . ' pixels.</p>';
	}
}
